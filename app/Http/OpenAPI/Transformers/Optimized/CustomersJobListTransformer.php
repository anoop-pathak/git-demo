...
namespace App\Http\OpenAPI\Transformers\Optimized;

use App\Transformers\Optimized\CustomersJobListTransformer as oCustomersJobListTransformer;

class CustomersJobListTransformer extends oCustomersJobListTransformer
{
