...
namespace App\Http\CustomerWebPage\Transformers\Optimized;

use App\Transformers\Optimized\CustomersJobListTransformer as cCustomersJobListTransformer;

class CustomersJobListTransformer extends cCustomersJobListTransformer
{
