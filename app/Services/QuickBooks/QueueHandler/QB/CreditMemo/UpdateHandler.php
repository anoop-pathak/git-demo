...
class UpdateHandler extends QBBaseTaskHandler
{
    ...
    function synch($task, $credit)
    {
        ...
        try {
            ...
            $jpCredit = QBCreditMemo::update($credit['Id']);
            return $jpCredit;
            ...
            return $this->reSubmit();
        } catch (CreditMemoNotSyncedException $e) {

            $meta = $e->getMeta();

            if (!ine($meta, 'credit_memo_id')) {
