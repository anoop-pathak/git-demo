(function() {
	...
	var dir  = function (JPEvent, $timeout, $injector) {
		return {
			...
			link: function (scope, iElement, iAttrs) {
				...
				var self = this;
				var TOPSIDE= JPAPP.getConfig().HUDSON_CONTRACTING;
				...
				*/
				self.isTopSideTemplate = function(id, editMode, element) {
					...
					if( TOPSIDE.TOPSIDE_TEMPLATE_ID.indexOf(parseInt(id)) > -1) {
						return true;
					}
				...
				*/
				self.isGBBTemplate = function(id, editMode, element) {
					...
					if( TOPSIDE.TOPSIDE_GBB_TEMPLATE.indexOf(JP.int(id)) > -1) {
						return true;
					}
	...
	*/
	angular
		.module('jobProgress')
		.directive('hudsonContractingBest1', dir);
})();