	...
	var dir = function ($injector, $timeout, $http, $filter, JPEvent) {
		return {
			...
			link: function (scope, iElement, iAttrs) {
				...
				var self = this;
				var BLAIR_REMOD = JPAPP.getConfig().A_AND_H_EXTERIORS;
		        ...
		        var init = function() {
					...
					**/
					$timeout(function() {
						...
						var els = iElement.find('.best-power-form.page1');
						if( els.length > 0 ) {
				...
				**/
				self.isTemplate2  = function(editMode, element) {
					...
					var els = iElement.find('.best-power-form.page2');
