<?php
	...
	return array(
		...
		3 => [
			...
			array(
				...
				'children' => array(
					array(
						...
						'children' => array(
							...
							array(
								...
								'description' => "Allow user to only View the sheet (Permission: 'View Unit Cost' must also be enabled).",
								'is_setting'=> false,
							),
							array(
					...
					array(
						...
						'description' => "Allow user to Add, Update & Delete financials and the ability to View & Print the Invoice Report.",
						'is_setting'=> false,
						'children' => array(
							array(
								'key'   => 'view_profit_loss_sheets',
							...
							array(
								...
								'description' => "Allow user to Manage the Sheet (Permission: 'View Unit Cost' must also be enabled).",
								'is_setting'=> false,
								'children' => array(),
							),
							array(
			...
			array(
				...
				'children' => array(
					...
					array(
						'key'	=> 'message_to_user_groups',
						'value'	=> 'Message to User Groups',
						'description' => "Allow user to send message in user group.",
						'is_setting'=> false,
						'children' => array(),
					),
					array(
						'key'	=> 'worksheet_settings_within_job',
						'value'	=> 'Worksheet Settings (Within Job)',
						'description' => "Allow user to edit the Worksheet Settings within a job.",
						'is_setting'=> false,
						'children' => array(),
					),
				),
		...
		// role id - 7(sub-contractor-prime)
		7 => [
			array(
				'key'	=> 'user_mobile_tracking',
				'value'	=> 'User Mobile Tracking',
