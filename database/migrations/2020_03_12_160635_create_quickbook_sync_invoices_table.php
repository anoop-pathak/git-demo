...
class CreateQuickbookSyncInvoicesTable extends Migration {
	...
	public function up()
	{
		Schema::create('quickbook_sync_invoices', function($table) {
			$table->increments('id');
	...
	{
		Schema::dropIfExists('quickbook_sync_invoices');
	}
