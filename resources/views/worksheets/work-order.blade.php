...
<body>
	...
	<?php	$createdDate = new Carbon\Carbon($work_order->created_at, Settings::get('TIME_ZONE')); ?>
	<div class="container">
				...
				<div class="financial-inner-section ng-scope" ng-if="previewMode">
					<div ng-include="&#39;views/includes/financial/sheet/section-preview.html&#39;" class="ng-scope">
						<div class="grid-section">
							...
							@endif
							<div class="grid-col" style="white-space: nowrap;"><label>Work Order #</label><span> {{ $work_order->serial_number}}</span></div>
							<div class="grid-col"><label>Work Order Date </label><span> {{$createdDate->format(config('jp.date_format'))}}</span></div>
						</div>
