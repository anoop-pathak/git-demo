				...
				<div class="financial-inner-section ng-scope" ng-if="previewMode">
					<div ng-include="&#39;views/includes/financial/sheet/section-preview.html&#39;" class="ng-scope">
						<div class="grid-section">
							...
							<div class="grid-col" style="white-space: nowrap;"><label>{{ $label }}</label><span> XXXX</span></div>
							<div class="grid-col"><label>Material List Date </label><span> {{ \Carbon\Carbon::now(Settings::get('TIME_ZONE'))->format(config('jp.date_format'))}}</span></div>				
						</div>
						...
						@endif
						@if(($purchaseOrderNumber = $job->purchase_order_number) && (!$for_srs))
