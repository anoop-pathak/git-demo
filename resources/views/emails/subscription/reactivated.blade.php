			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
					 	<p style="font-family: arial,sans-serif; margin: 0px; padding: 5px 2px;  font-size: 16px; color: rgb(106, 106, 106);">
					 		Welcome Back! 
					 	</p>
						...
						Your JobProgress services for {{$company_name}} have been successfully restored. You can now resume your business activities on JobProgress and we would sincerely look forward to keep serving you in future.
						<br><br>
							Thanks<br>
							Support Team
						</p>
