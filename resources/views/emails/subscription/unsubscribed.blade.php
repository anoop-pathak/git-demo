			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						...
						You have successfully unsubscribed from JobProgress services for {{$company_name}}. Although we regret to learn about this but certainly respect your decision and would sincerely hope to serve you again very soon in the near future. In the event that you require any assistance as your transition away from JobProgress, you are welcome to call us anytime at {{config('jp.TOLL_FREE_NUMBER')}}
						<br><br>
						To restore your services please click <a href="{{ config('jp.login_url') }}">here</a> or contact JobProgress {{config('jp.TOLL_FREE_NUMBER')}}
						</p><br>
							<p style="font-family: arial,sans-serif; margin: 0px; padding: 5px 2px; font-size: 15px; color: rgb(106, 106, 106);">
							Thanks<br>
							Support Team
