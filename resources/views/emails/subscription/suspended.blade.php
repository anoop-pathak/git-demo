			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						...
						Your JobProgress subscription account for {{$company_name}} has been suspended due to payment failure but you don't need to worry yet. We are suspecting some issue in your billing info and therefore request you to review / update it <a href="">here</a>. Your services would be restored as soon as the payment is made.
						<br><br>
