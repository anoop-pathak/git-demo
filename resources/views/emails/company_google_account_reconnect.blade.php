			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						...
						Your Company's Google account [{{ $google_account }}] has been disconnected. Therefore you are not able to use Google sheet feature.
						<br><br>
						Kindly reconnect your Company's Google account from setting page.
						<br><br>
							Thanks<br>
							JobProgress Support
						</p>
