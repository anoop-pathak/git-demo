			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						...
						Your Google account [{{ $google_account }}] has been disconnected and your staff calendar is no more in Sync with Google calendar.
						<br><br>
						Kindly reconnect your Google account from your profile page.
						<br><br>
							Thanks<br>
							JobProgress Support
						</p>
