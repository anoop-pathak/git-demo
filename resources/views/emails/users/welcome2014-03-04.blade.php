			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: 0 auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						<p style="font-family: arial,sans-serif; margin: 0px; padding: 5px 2px;  font-size: 14px; font-weight:bold; color: rgb(106, 106, 106);">Dear {{$first_name}} {{$last_name}},</p>
						<p style="font-family: arial,sans-serif; margin: 0px; padding: 5px 2px; font-size: 15px; color: rgb(106, 106, 106);">You are successfully subscribed on JobProgress.com with following details: </p>
						<table style="color:#000000;font-size:13px;font-family:arial,sans-serif;">
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 14px; font-weight:bold; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Company Name :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$company_name}}</td>
							</tr>
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 14px; font-weight:bold; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Subscriber ID :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$company_id}}</td>
							</tr>
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 14px; font-weight:bold; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Plan :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$plan}}</td>
							</tr>
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 14px; font-weight:bold; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Users :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$users}}</td>
							</tr>
						</table>
						<p style="text-align:center;padding: 20px 15px; padding-bottom:0;" ><a style="text-decoration:none;color: #FFF;background-color: #337AB7;border: 1px solid #2E6DA4;border-radius: 4px;padding: 6px 12px;text-align: center;white-space: nowrap;" href="{{ config('jp.login_url')}}" >Click here to login</a></p>
					</td>
				</tr>
