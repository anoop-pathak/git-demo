			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: 0 auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						...
						<p style="font-family: arial,sans-serif; margin: 0px; padding: 5px 2px; font-size: 15px; color: rgb(106, 106, 106);">There is a new subscription with following details: </p>
						<table style="color:#000000;font-size:13px;font-family:arial,sans-serif;">
							...
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 15px; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Company Name :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$company_name}}</td>
							</tr>
							<tr>
							...
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 15px; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Plan :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$plan}}</td>
							</tr>
							<tr>
								<td style="vertical-align:top;padding:5px 0;width:150px;font-size: 15px; color: rgb(106, 106, 106);" cellspacing="0" cellpadding="0">Users :</td><td style="vertical-align:top;padding:5px 0;font-size: 15px; color: rgb(106, 106, 106);"> {{$users}}</td>
							</tr>
						</table>
					</td>
				</tr>
