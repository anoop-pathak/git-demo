			...
			<table cellspacing="0" style="color: rgb(0, 0, 0); width: 600px; margin: auto;">
				...
				<tr>
					<td cellspacing="0" cellpadding="0" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
						...
						<p style="font-family: arial,sans-serif; margin: 0px; padding: 5px 2px; font-size: 15px; color: rgb(106, 106, 106);">Company activation is completed. You can login now. </p>
					</td>
				</tr>
				<tr>
					<td cellspacing="0" cellpadding="0" align="center" style="color: rgb(0, 0, 0); background: #f9f9f9; padding: 20px 15px;">
					<p style="text-align:center;" ><a style="text-decoration:none;color: #FFF;background-color: #337AB7;border: 1px solid #2E6DA4;border-radius: 4px;padding: 6px 12px;text-align: center;white-space: nowrap;" href="{{ config('jp.login_url')}}" >Click here to login</a></p>
					</td>
				</tr>
				<tr>
