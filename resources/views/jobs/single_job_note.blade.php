...
<head>
	...
	<link rel="stylesheet" href="{{ Config::get('app.url') }}css/main.css" />
	...
	<div class="container">
		<div class="jobs-export">
			<div class="header-part">
				...
				@endif
				<h1 style="width:56%;">{{ $company->name or '' }}</h1>
							...
							<div class="cust-job-detail work-crew-listing">
								<div class="details-col">
									...
									<div class="row work-crew-row">
										<div class="col-md-12">
											<p style="white-space: pre-wrap;">{{ $job_note->note }}</p>
										</div>
									</div>
								</div>
							</div>
